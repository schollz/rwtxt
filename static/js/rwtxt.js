...
function onUploadFinishedQQ(filename, uri) {
	...
	prefix = "!"
	// }
	var extraText = prefix + "[" + filename + "](" + uri + ")"

	var newLine = "\n"
	document.getElementById("editable").value = textBefore + extraText + newLine + textAfter
...
function onUploadFinished(file) {
	...
	var extraText = prefix + "[" + file.xhr.getResponseHeader("Location").split("filename=")[1] + "](" + file.xhr.getResponseHeader("Location") + ")"
